// Fork of TommySim
// Original Repo may be found at https://github.com/TommyWaalkes/TommySim
...
namespace Objects2Multiple
{
    class City
    {
        ...
        public void BuildFarm()
        {
            ...
            {
                wood -= 6;
                foodSources.Add(new FoodSource("Farm", 1));
                Console.WriteLine("You Built a farm!");
            }
            else
            {
                Console.WriteLine("You didn't build a well! You need at least 6 wood.");
        ...
        public int calculateFoodPerTurn()
        {
            ...
            {
                Console.WriteLine("Your " + f.name + " produces " + f.supply + " buschels of food per turn");
                total += f.supply;
            }
        ...
        {
            Console.WriteLine(name + " has " + food + " bushcels of food.");
        }
