...
let usa = new Country("USA", "Murican", "Hey bud", ["red", "white", "blue"]);
let mexico = new Country("Mexico", "Spanish", "Hola Mundo", ["red", "white", "green"]);
let algeria = new Country("Algeria", "Arabic & Berber", "Sup bro", ["blue", "yellow", "red"]);
let rome = new Country("Rome", "Latin", "Salve Munde!", ["red", "gold", "purple"]);
let china = new Country("China", "Mandarin", "Nihao!", ["red", "yellow", "yellow"]); 
let countries = [];
